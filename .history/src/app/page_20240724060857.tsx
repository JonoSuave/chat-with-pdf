...
export default function Home() {
	return (
		<main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
            ...
            <h2 className="text-base font-semibold leading-7 text-indigo-600">Your Interactive Dcoument Companion</h2>
            ...
            <p>
              ...
              <br />
              <br /> Upload your document, and our chatbot will answer questions, summarize content, and asnwer all your Qs. Ideal for everyone, <span className="text-indigo-600"> Chat with PDF</span>{" "}
