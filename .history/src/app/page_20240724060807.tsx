	...
	return (
		<main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
            ...
            <p>
              ...
              <br />
              <br /> Upload your document, and our chatbot will answer questions, summarize content, and asnwer all your Qs. Ideal for everyone, <span className="text-indigo-600"></span>
            </p>
          </div>
				</div>
			</div>
